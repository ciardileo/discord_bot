...
class Others(commands.Cog):
	...
	async def on_message(self, message):
		if "c/" in message.content and not "@" in message.content:
			await message.channel.send('🤖 Irmão, se você queria me chamar, meu prefixo voltou pra `>`')
			self.console.log(f'[green]{message.author}[/] tentou chamar o bot pelo prefixo errado')
